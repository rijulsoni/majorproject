...
import "./WirelessSpeakers.css";
import { toast } from "react-hot-toast";
import { UseCart } from "../../context/cart";

export default function WirelessSpeakers() {
  ...
  const WirelessSpeakers = filteredProducts.filter(
    (product) => product.category === "Wireless Speakers"
  );
  return (
    <div className="body">
      ...
      <div className="contain d-flex justify-content-center mt-50 mb-50">
        <div className="row">
          ...
          {WirelessSpeakers.length > 0 ? (
            WirelessSpeakers.map((product) => (
                ...
                <div className="card card-body">
                  <div className="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                    ...
                    toast.success("Item Added To Cart")}}
                        type="button"
                        className="btnpro mt-4 text-white"
                      >
