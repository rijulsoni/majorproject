...
export default function WirelessEarbuds() {
  ...
  const wirelessEarbuds = filteredProducts.filter(
    (product) => product.category === "Wireless Earbuds"
  );
  return (
    <div className="body">
      ...
      <div className="contain d-flex justify-content-center mt-50 mb-50">
        <div className="row">
          ...
          {wirelessEarbuds.length > 0 ? (
            wirelessEarbuds.map((product) => (
