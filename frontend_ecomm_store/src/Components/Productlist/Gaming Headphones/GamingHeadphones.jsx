...
import "./GamingHeadphones.css";
import { UseCart } from "../../context/cart";
import { toast } from "react-hot-toast";
export default function GamingHeadphones() {
  ...
  const GamingHeadphones = filteredProducts.filter(
    (product) => product.category === "Gaming Headphones"
  );
  return (
    <div className="body">
      ...
      <div className="contain d-flex justify-content-center mt-50 mb-50">
        <div className="row">
          ...
          {GamingHeadphones.length > 0 ? (
           GamingHeadphones.map((product) => (
